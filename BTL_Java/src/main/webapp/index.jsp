...
<body>
    ...
    <ul class="navbar">
        ...
        <li><a href="#">KHOA</a>
        	<ul class="dropdown">
		      ...
		      <li><a href="#">KHOA MẠNG MÁY TÍNH VÀ TRUYỀN THỐNG</a></li>
		    </ul>
        </li>
        <li><a href="#">PHÒNG/TRUNG TÂM</a>
        	<ul class="dropdown">
    ...
    <div class="slideshow-container">
        <img class="slide" src="images/ufi2226.jpg" alt="Ảnh 1">
        <img class="slide" src="images/ufi2234.jpg" alt="Ảnh 2">
        <img class="slide" src="images/ufi2235.jpg" alt="Ảnh 3">
    </div>
